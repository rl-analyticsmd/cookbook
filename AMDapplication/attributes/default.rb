...
default[:AMDapplication][:packages] = ['epel-release','R', 'gcc', 'gcc-c++', 'kernel-devel', 'python-pip', 'git', 'mariadb-devel', 'python-devel', 'ncurses-devel', 'gcc', 'python-ldap', 'Cython', 'openldap-devel', 'pycrypto', 'expect', 'npm', 'wkhtmltopdf', 'libxslt-devel', 'libffi-devel', 'openssl-devel']